    ...
    <div className="relative bg-gradient-to-r from-blue-500 to-indigo-600 dark:from-gray-800 dark:to-gray-900 py-16 sm:py-20 px-4 sm:px-6 lg:px-8 text-center overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        <form
          ...
          className="flex flex-col sm:flex-row items-center justify-center gap-3 mb-6 animate-fade-in-up animation-delay-400"
        >
          <div className="relative w-full max-w-md group">
            ...
            />
            <Search
              className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 dark:text-gray-500 transition-all duration-300 group-hover:text-blue-500"
              size={18}
            />
          </div>
